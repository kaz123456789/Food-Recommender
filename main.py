...
class _Vertex:
    ...
    def __init__(self, name: str, kind: str, price: int, latitude: float, longitude: float) -> None:
...
class Graph:
    ...
    def add_vertex(self, name: str, kind: str, price: int, latitude: float, longitude: float) -> None:
        ...
        if name not in self._vertices:
            self._vertices[name] = _Vertex(name, kind, price, latitude, longitude)
